...
async function sendIntakeWhatsapp(slug: string, whatsapp: string) {
  ...
  const message = [
    ...
    `הצעדים הבאים:`,
    ``,
    `1️⃣ *מילוי פרטים* (~3 דקות) — כולל בחירת כתובת האתר (Domain)`,
    intakeUrl,
    ``,
    `2️⃣ אחרי שתשלח את הטופס — אנחנו רוכשים את הדומיין ומחברים אותו תוך *24-48 שעות*. תקבל הודעה ברגע שהאתר חי.`,
    ``,
    `3️⃣ *פורטל אישי לעריכה* — טקסטים, צבעים, לוגו, ביקורות, ניהול מנוי:`,
    portalLink,
    ``,
    `שמור את שני הקישורים — שניהם אישיים.`,
  ].join('\n')
