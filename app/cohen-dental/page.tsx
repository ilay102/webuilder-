...
const CAL_COLOR = '#2D6B55';          // matches forest green
...
function ServiceCard({ icon, title, desc, delay }: { icon: string; title: string; desc: string; delay: number }) {
  ...
  return (
    <motion.div
      ...
      style={{
        background: hovered ? C.white : C.bg,
        borderRadius: 20,
        padding: '36px 32px',
    ...
    <div style={{ background: C.bg, minHeight: '100vh', fontFamily: F.body }}>
      ...
      <section style={{ position: 'relative', height: '100vh', overflow: 'hidden' }}>
        ...
        <div style={{
          ...
          background: 'linear-gradient(to right, rgba(250,248,244,0.92) 38%, rgba(250,248,244,0.2) 70%, transparent 100%)',
        }} />
        ...
        <div style={{
          ...
          padding: '0 80px', maxWidth: 1200, margin: '0 auto', left: 0, right: 0,
        }}>
          <div style={{ maxWidth: 560 }}>
            <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
              <Tag>Premium Dental Care · Tel Aviv</Tag>
            </motion.div>
            ...
            >
              Your Smile,<br />
              <span style={{ color: C.forest }}>Our Passion</span>
            </motion.h1>
            ...
            >
              A boutique dental clinic where cutting-edge technology meets a calm, welcoming environment. Because great dental care should feel like self-care.
            </motion.p>
            ...
            >
              <CalBooking calLink={CAL_LINK} brandColor={CAL_COLOR}>
                <button style={{
                  ...
                  boxShadow: '0 8px 24px rgba(45,107,85,0.30)',
              ...
              <button style={{
                ...
                fontFamily: F.label, fontWeight: 600, fontSize: 15,
                padding: '16px 36px', borderRadius: 99,
                border: `1.5px solid rgba(42,42,42,0.20)`, cursor: 'pointer',
                transition: 'all 0.2s ease',
              }}
      ...
      <section id="services" style={{ padding: '120px 80px', maxWidth: 1200, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 64, gap: 32 }}>
          <h2 style={{ fontFamily: F.serif, fontSize: 'clamp(32px, 4vw, 52px)', fontWeight: 700, color: C.charcoal, letterSpacing: '-0.03em', lineHeight: 1.1, maxWidth: 480 }}>
            Complete Care,<br />
            <span style={{ color: C.forest }}>One Trusted Place</span>
          </h2>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center' }}>
          ...
          >
            ...
            <div style={{
              ...
              <div>
                ...
                <div style={{ fontFamily: F.body, fontSize: 13, color: C.muted }}>Tel Aviv · 2024</div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <p style={{ fontFamily: F.body, fontSize: 16, color: C.muted, lineHeight: 1.8, marginBottom: 20 }}>
              We built Dr. Cohen Dental because we believed dental visits shouldn't feel clinical or stressful. Our clinic is designed from the ground up to be calm, beautiful and reassuring — without compromising on precision.
            </p>
            <p style={{ fontFamily: F.body, fontSize: 16, color: C.muted, lineHeight: 1.8, marginBottom: 40 }}>
              Every detail — from the oak cabinetry to the large garden-facing windows — is intentional. Our team of 12 specialists brings warmth and expertise together, every single appointment.
            </p>
            <button style={{
              background: C.forest, color: '#fff',
      ...
      <section style={{ padding: '120px 80px', maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center' }}>
        ...
        >
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }}>
            {[
              { value: '1,200+', label: 'Smile Makeovers' },
        ...
        <motion.div
          ...
          style={{ borderRadius: 24, overflow: 'hidden', boxShadow: '0 32px 80px rgba(45,107,85,0.15)' }}
        >
      ...
      <section style={{ position: 'relative', height: 560, overflow: 'hidden' }}>
        ...
        <div style={{
          ...
          textAlign: 'center' as const, padding: '0 40px',
        }}>
          <motion.div
            initial={{ opacity: 0, y: 24 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <CalBooking calLink={CAL_LINK} brandColor={CAL_COLOR}>
              <button style={{
                ...
                fontFamily: F.label, fontWeight: 700, fontSize: 16,
      ...
      <footer style={{ background: C.charcoal, padding: '64px 80px 40px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: 48, marginBottom: 56 }}>
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 20 }}>
                ...
                <span style={{ fontFamily: F.serif, fontWeight: 700, fontSize: 18, color: '#fff' }}>Dr. Cohen Dental</span>
              </div>
              <p style={{ fontFamily: F.body, fontSize: 14, color: 'rgba(255,255,255,0.45)', lineHeight: 1.8, maxWidth: 260 }}>
                Premium dental care in the heart of Tel Aviv. Where your comfort and confidence come first.
              </p>
            </div>
            {[
              ...
              { title: 'Contact', links: ['03-000-0000', 'hello@smilestudio.co.il', 'Rothschild Blvd, TLV', 'Sun–Thu 9:00–18:00'] },
            ].map(({ title, links }) => (
              <div key={title}>
          ...
          <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', paddingTop: 28, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <span style={{ fontFamily: F.body, fontSize: 13, color: 'rgba(255,255,255,0.30)' }}>© 2026 Dr. Cohen Dental. All rights reserved.</span>
      ...
      <Chatbot config={{
        ...
        brandColor: '#2D6B55',
        greeting: "Hi! 👋 I'm the Dr. Cohen Dental assistant. How can I help you today?",
        clientEmail: 'ilay1bgu@gmail.com',   // ← swap per client
        clientWhatsapp: '972501234567',        // ← swap per client (no + or spaces)
      }} />
