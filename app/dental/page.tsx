...
const BIZ = {
  name:          'Smile Studio',
  tagline:       'A boutique dental clinic where cutting-edge technology meets a calm, welcoming environment. Because great dental care should feel like self-care.',
  city:          'Tel Aviv',
  address:       'Rothschild Blvd, TLV',
  phone:         '03-000-0000',
  email:         'hello@smilestudio.co.il',
