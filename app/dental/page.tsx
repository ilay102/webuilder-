  ...
  return (
    <div style={{ background: C.bg, minHeight: '100vh', fontFamily: F.body }}>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center' }}>
          ...
          >
            ...
            <p style={{ fontFamily: F.body, fontSize: 16, color: C.muted, lineHeight: 1.8, marginBottom: 20 }}>
              We built Smile Studio because we believed dental visits shouldn't feel clinical or stressful. Our clinic is designed from the ground up to be calm, beautiful and reassuring — without compromising on precision.
            </p>
      ...
      <footer style={{ background: C.charcoal, padding: '64px 80px 40px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: 48, marginBottom: 56 }}>
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 20 }}>
                ...
                <span style={{ fontFamily: F.serif, fontWeight: 700, fontSize: 18, color: '#fff' }}>Smile Studio</span>
              </div>
          ...
          <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', paddingTop: 28, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <span style={{ fontFamily: F.body, fontSize: 13, color: 'rgba(255,255,255,0.30)' }}>© 2026 Smile Studio. All rights reserved.</span>
      ...
      <Chatbot config={{
        ...
        brandColor: '#2D6B55',
        greeting: "Hi! 👋 I'm the Smile Studio assistant. How can I help you today?",
