...
const TIERS = [
  {
    ...
    includes: [
      ...
      '🌐 דומיין משלך (.co.il או .com) — כלול במחיר, מסירה תוך 24-48 שעות',
  ...
  },
  {
    ...
    includes: [
      'הכל ממסלול הבסיס (כולל דומיין משלך)',
...
const NOT_INCLUDED = [
  ...
  'SEO מתקדם / קידום אורגני (אנחנו רק בונים את התשתית)',
  'ניהול גוגל מפות (GMB) — אנחנו שולחים מדריך, אתם מבצעים',
